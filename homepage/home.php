...
<nav class="navbar navbar-expand-lg navbar-light sticky-top">
  <div class="container">
    <a class="navbar-brand" href="#"><img src="images/logo/logo.png" alt="EduTrack" style="height:40px;" class="me-2"></a>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        ...
        <p class="hero-subtitle">EduTrack simplifies student management with powerful tools for attendance, grades, and more.</p>
      ...
      <div class="col-lg-6 mt-5 mt-lg-0">
        <img src="images/sdash.png" alt="EduTrack Dashboard" class="hero-img">
      </div>
    </div>
  </div>
</section>
...
<section id="about" class="section bg-light">
  <div class="container">
    <h2 class="text-center section-title">About EduTrack</h2>
    <div class="row align-items-center">
      <div class="col-lg-6"><img src="images/about.jpeg" class="img-fluid rounded" alt="About EduTrack"></div>
      <div class="col-lg-6 mt-4 mt-lg-0">
        <h3>Simplifying Student Management</h3>
        <p>EduTrack helps institutions manage student data, attendance, grades efficiently.</p>
...
<section id="features" class="section">
  <div class="container">
    ...
    <p class="text-center mb-5">Discover the powerful features of EduTrack</p>
    <div class="row g-4">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="card feature-card p-4 text-center">
          ...
          <p>Access EduTrack from any device, anywhere.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-6 mt-4 mt-lg-0">
        <div class="card border-0 shadow-sm h-100 p-4">
          ...
          <p class="mb-1"><i class="fas fa-envelope me-2 text-primary"></i>info@edutrack.com</p>
