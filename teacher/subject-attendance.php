...
<div class="main-content">
    <div class="content">
        <div class="dashboard-card mb-4">
            <h2 class="mb-2">Subject Attendance</h2>
            ...
            <?php else: ?>
                ...
                <div class="mb-4">
                    <h5>Mark Attendance (UI only, backend not implemented)</h5>
                                ...
                                <tbody>
                                    <?php foreach ($students as $student): ?>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" name="present[<?php echo $student['student_id']; ?>]" value="1"></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
